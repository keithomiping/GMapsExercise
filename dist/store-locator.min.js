(function($) {
	this.apiKey_ = "AIzaSyCJbXjRv9xHRPPjK-SkDsfYreiFR67izbU";
    ...
    storeLocator.GMEDataFeed.prototype.getStores = function(a, b, c) {
        ...
        $.getJSON("https://www.googleapis.com/mapsengine/v1/tables/" + this.tableId_ + "/features?callback\x3d?", {
            key: "AIzaSyCJbXjRv9xHRPPjK-SkDsfYreiFR67izbU",
            where: a,
            version: "published",
            maxResults: 300
        }, function(a) {
    ...
    storeLocator.Panel.prototype.init_ = function() {
        ...
        this.settings_.directions && (this.directionsPanel_ = $('\x3cdiv class\x3d"directions-panel" style="display:none"\x3e\x3cform style="display:none"\x3e\x3cinput class\x3d"directions-to"/\x3e\x3cinput type\x3d"submit" style="display:none" value\x3d"Find directions"/\x3e\x3ca href\x3d"#" style="display:none class\x3d"close-directions"\x3eClose\x3c/a\x3e\x3c/form\x3e\x3cdiv class\x3d"rendered-directions"\x3e\x3c/div\x3e\x3c/div\x3e'), this.directionsPanel_.find(".directions-to").attr("readonly", "readonly"), this.directionsPanel_.hide(),
            this.directionsVisible_ = !1, this.directionsPanel_.find("form").submit(function() {
				alert('directions button clicked');	
